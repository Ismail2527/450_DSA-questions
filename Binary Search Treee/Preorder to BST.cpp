  ...
  public:
    ...
    Node* solve(int pre[], int size) {
        ...
        for (int i = 1; i < size; ++i) {
            ...
            // Keep popping until the current element is greater
            // than the stack's top element.
            ...
            // If the current element is less than the stack's top
            // element, make it the left child of the stack's top element
            else {
